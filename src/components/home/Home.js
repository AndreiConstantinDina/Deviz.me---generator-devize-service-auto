        ...
        <div className="home-container">
            ...
            <div id="resources" className="home-hero">
                <div className="home-content-container">
                    <div className="home-hero-text">
                        <h1 className="home-heading">Deviz.me</h1>
                        <span className="home-text Section-Text">
              singura platformă auto de care vei avea nevoie
            </span>
                    </div>
                </div>
            </div>
            ...
            <div id="ourstory" className="home-our-story">
                <div className="home-heading-container2">
                    <h1 className="home-text16">Cine suntem?</h1>
            ...
            odio. Praesent libero.
              ...
              <span className="home-heading07 Card-Heading">
                ...
                <span className="home-text22 SmallCard-Heading">
                  This text is the name of the article. Lorem ipsum dolor sit
                  metsed ...
                </span>
                                <span className="Anchor">Read more</span>
                        ...
                        <div className="home-card1">
                            <img
                                alt="image"
                                src="https://media.istockphoto.com/id/681733108/ro/fotografie/mecanic-la-locul-s%C4%83u-de-munc%C4%83-a-face-munca-sa-de-zi-cu-zi-auto-repair-service.jpg?s=2048x2048&w=is&k=20&c=zRbZxYzN6IDkx7ZNgux0PBX9FWni9QQdlAO9IwAGnuI="
            ...
            <div className="home-get-in-touch">
                <h2 className="home-text34 Section-Heading">
                    Ia legatura cu echipa noastră:
                </h2>
                <div className="home-content-container6">
                    <div className="home-form-container">
                        <span className="home-heading08 BigCard-Heading">Contact</span>
                        <input
                            type="text"
                            required="true"
                            placeholder="Name"
                    ...
                    <div className="home-locations-container">
                        <div className="home-location-1">
                            <span className="home-heading09">Romania</span>
