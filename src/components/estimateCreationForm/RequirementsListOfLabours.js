...
export default function RequirementsListOfLabours({problemsData, setProblemsDict, problemsDict, value, labourData, setLabourData}) {
        ...
        for (let i = 0; i<dict.length; i++) {
            ...
            try{
                ...
                if (elem.key === value) {
                    ...
                    let labourToDelete = labourData.items.find((element) => element.item === val).item
                    // console.log('-----')
