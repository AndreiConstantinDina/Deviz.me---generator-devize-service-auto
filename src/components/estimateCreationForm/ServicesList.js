...
export default function ServicesList({itemsData, setItemsData, requirementsLabourData,
    ...
    const handleItemDelete = (value) => {
        ...
        {
            setDeletionError("Aceast serviciu nu poate fi ștears deoarece este asociat unei constatări!")
                ...
                >
                    <Grid container spacing={0} direction={'row'} alignItems={'center'} justifyContent={'space-between'}>
                        ...
                        <Grid item>
                            ...
                            <TextField label={"Tarif"} type={'text'} sx ={{width: '8vw'}} value={item.price}
                                       onChange={(event) => {
